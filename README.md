...
* When the user enters exit *[stat]*, *Hell Shell* will end and returns the inputted status, where *stat* is a value from 0 to 255. 
...
* This program executes the most common shell commands as *ls*, *grep*, *find*, *pwd*, *rm*, *cp*, *mv*, *exit*, *env*, *hist*, etc... with arguments.
...
- *Kev Tay * - [@ke-sabali](https://github.com/kev-sabali) 
- *Nasma Aboubakary*  - [@Nasma2022](https://github.com/Nasma2022)
